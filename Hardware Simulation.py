...
ins_memory = [               
                '00000000000000000','01100000000000001','01100000100000010','01011000000000001','01011000100000010','00010000000010010','01100001000000000','10000010000000000','00000000000000000','00000000000000000','01100000000000011','01100000100000100','01011000000000011','01011000100000100','00011000000010010','01100001000000000','10000010000000000','00000000000000000','01110000000000000','01100000000000101','01110000000000000','01100000000000110','01011000000000101','01110010000000000','01011000000000110','01110010000000000','01011000000000101','01011000100000110','10000000000000001','01011000000000000','01100000000000111','01011000000000111','01110010000000000','01110000000000000','01100000000000101','01110000000000000','01100000000000110','01011000000000101','01110010000000000','01011000000000110','01110010000000000','01011000000000101','01011000100000110','10000000000001011','01011000000000000','01100000000000111','01011000000000111','01110010000000000','00000000000000001',
                0 
             ]
...
def oopcode_path(s):
    ...
    elif oopcode in ['01010','01011','01100','01111']:
        mem_address_path(s)
...
def salu_process(r2, s_oopcode, r12):
    if s_oopcode in s_alu:
        reg[r12] = s_alu[s_oopcode](reg[r2]).zfill(8)
    else:
        reg[r12] = '11110000'
...
def alu_address_path(s):
    ...
    addr2 = s[9:13]
    addr3 = s[13:17]
    print(s,reg[addr1],reg[addr2],reg[addr3])
...
def stack_process(s):
    ...
    if path == '00':
        ...
        stack.append(format(program_counter + 1, '010b'))  # Assuming 17-bit program counter
