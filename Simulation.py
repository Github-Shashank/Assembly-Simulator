...
# Memory
ins_memory = [               
                '01110000000000000','01100000000000000','01110000000000000','01100000000000001','01011000000000000','01011000100000001','01001010100000001','01011000000000000','01110010000000000','00000000000000000','01011000000000001','01110010000000000','00000000000000000','00000000000000001',
                0 
            ]
...
def reset():
    global ins_memory,rom,reg,instruction_tracker,program_counter,program_counter_bin,steps_counter,jump,mul,boolean,jmp,cal,stack
    ins_memory = [               
                    '01110000000000000','01100000000000000','01110000000000000','01100000000000001','01011000000000000','01011000100000001','01001010100000001','01011000000000000','01110010000000000','00000000000000000','01011000000000001','01110010000000000','00000000000000000','00000000000000001',
                    0 
                ]
...
def run_code(bin_file):
    global ins_memory,rom,reg,instruction_tracker,program_counter,program_counter_bin,steps_counter,jump,mul,boolean,jmp,cal,stack
    # Program Counter
    if not bin_file.endswith(".pybin") :
        reset()
        raise FileExistsError(f"{bin_file} should ends with .pyasm")
